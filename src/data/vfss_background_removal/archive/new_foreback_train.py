...
from src.models.u_net.utils.data_loading import BasicDataset
from src.models.u_net.evaluate import evaluate
from src.models.u_net.utils.dice_score import dice_loss
...
def train_model(
    ...
    augmentations = A.Compose([
        ...
        A.RandomBrightnessContrast(p=0.0, brightness_limit=0.05, contrast_limit=0.05),
    ...
    for epoch in range(1, epochs + 1):
        ...
        log_train_augment_preview(train_set, fixed_indices_to_track, epoch, experiment, count=8)
